 ...
 * 
 */
@WebServiceClient(name = "HelloWSService", targetNamespace = "http://webservice.study.maple.com/", wsdlLocation = "http://localhost:8989/ws/hello?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOWSSERVICE_QNAME = new QName("http://webservice.study.maple.com/", "HelloWSService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8989/ws/hello?wsdl");
    ...
    public HelloWS getHelloWSPort() {
        return super.getPort(new QName("http://webservice.study.maple.com/", "HelloWSPort"), HelloWS.class);
    }
    ...
    public HelloWS getHelloWSPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://webservice.study.maple.com/", "HelloWSPort"), HelloWS.class, features);
    }
